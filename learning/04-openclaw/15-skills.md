...
> [!NOTE]
> **You are building your own agent from scratch.** There is no external package to install. The files in `src/agent.ts`, `src/adapters/`, and `src/skills/` are 100% your own code following the OpenClaw architecture pattern. This is better — you have full control!
